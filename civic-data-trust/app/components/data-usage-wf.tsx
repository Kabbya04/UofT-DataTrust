...
import { Download, Upload, Eye, Share2, Calendar, TrendingUp, Database, Users } from "lucide-react"
import { Card, CardContent, CardHeader, CardTitle } from "./ui/card"
import { Button } from "./ui/button"
import { Badge } from "./ui/badge"
import { Tabs, TabsContent, TabsList, TabsTrigger } from "./ui/tabs"

export function DataUsageWF() {
  ...
  const recentActivity = [
    {
      id: 1,
      action: "Downloaded",
      dataset: "Healthcare Analytics Dataset 2024",
    ...
    },
    {
      id: 2,
      action: "Uploaded",
      dataset: "Urban Traffic Patterns",
      community: "Smart Cities Initiative",
      size: "856 MB",
      time: "5 hours ago",
      type: "upload"
    },
    ...
    },
    {
      id: 4,
      action: "Viewed",
      dataset: "Financial Market Trends Q4",
    ...
    },
    {
      id: 5,
      action: "Downloaded",
      dataset: "Gaming Behavior Analytics",
    ...
    <div className="flex-1 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{usageStats.totalUploads}</div>
            <p className="text-xs text-foreground flex items-center gap-1">
              <TrendingUp className="h-3 w-3" />
              +23% from last month
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{usageStats.storageUsed}</div>
            <p className="text-xs text-muted-foreground">
              of {usageStats.storageLimit} limit
            </p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-sm text-foreground">{activity.dataset}</span>
                      </div>
                      <div className="flex items-center gap-4 text-xs text-muted-foreground">
                        <span>Community: {activity.community}</span>
                        <span>Size: {activity.size}</span>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <Badge variant="secondary">234 activities</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm">Last Week</span>
                  <Badge variant="outline">198 activities</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm">This Month</span>
                  <Badge variant="secondary">1,024 activities</Badge>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm">Last Month</span>
                  <Badge variant="outline">896 activities</Badge>
                </div>
              </div>
            </Card>
          </div>
