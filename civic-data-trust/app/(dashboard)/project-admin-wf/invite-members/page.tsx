...
import { ArrowLeft, Mail, UserPlus, Users, Search, Shield, Eye, Settings, Plus, X } from 'lucide-react';
import Link from 'next/link';

type InviteRole = 'community-member' | 'researcher' | 'project-admin';
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <RadioGroup value={selectedRole} onValueChange={(value: InviteRole) => setSelectedRole(value)}>
                                        <div className="space-y-3">
                                            {(['community-member', 'researcher', 'project-admin'] as InviteRole[]).map((role) => {
