  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-wider">Membership Status Tracking</h1>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-neutral-700">
                  ...
                  <th className="text-left py-3 px-4 text-xs font-medium text-neutral-400 tracking-wider">COMMUNITY</th>
