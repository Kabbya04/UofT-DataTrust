...
const MembershipRequestInterface = () => {
  ...
  return (
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-wider">Membership requests</h1>
      ...
      <Card className="bg-neutral-900 border-neutral-700">
        <CardHeader>
          <CardTitle className="text-sm font-medium text-neutral-300 tracking-wider">Before accept any request view the detail</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-neutral-700">
                  <th className="text-left py-3 px-4 text-xs uppercase font-medium text-neutral-400 tracking-wider">Request ID</th>
                  <th className="text-left py-3 px-4 text-xs uppercase font-medium text-neutral-400 tracking-wider">Name</th>
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-2xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button className="bg-orange-500 hover:bg-orange-600 text-white">Accept Request</Button>
                <Button
                  variant="outline"
