// civic-data-trust/app/(dashboard)/community-member-wf/community-member/dashboard/page.tsx
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <ActionCard
          href="/community-member-wf/data-center/upload-dataset"
          icon={UploadCloud}
          title="Upload Dataset"
          description="Contribute to the data trust by uploading a new dataset for community use."
        />
        <ActionCard
          href="/community-member-wf/request-center/request-review"
          icon={FileSearch}
          title="Review Requests"
          description="View and manage pending data access requests from other members."
        />
        <ActionCard
          href="/community-member-wf/community-discovery-and-membership/community-discovery-portal"
          icon={Search}
          title="Discover Communities"
          description="Explore and find new communities to join and collaborate with."
        />
        <ActionCard
          href="/community-member-wf/authentication-profile/profile-management"
          icon={UserCog}
